...
export const heartwork: ProjectRecord = {
  ...
  headline: "A CREATOR COMMUNITY WORTH COMING BACK TO.",
  client: "Lay's (PepsiCo)",
  year: 2020,
  projectKind: "campaign",
  heroLegacySrc: "/assets/work/lays/heartwork/heartwork-hero.jpg",
  renderMode: "flexible",
  companySlug: "pepsico",
  brandSlug: "lays",
  businessCategorySlugs: FMCG,
  ...
  sections: [
    {
      ...
      eyebrow: "CHAPTER 01 · THE CAMPAIGN BRIEF",
      heading: "WHEN THE COUNTRY KEPT MOVING, SOME PEOPLE MADE THAT POSSIBLE.",
      body: "Lay's #Heartwork thanked India's unsung heroes — farmers, factory workers, delivery people, shopkeepers, truck drivers, retailers, and others keeping daily life moving through COVID lockdown. The brief was clear and human: express genuine brand gratitude to the essential workforce keeping the country running.",
    },
    {
      blockType: "sectionIntro",
      eyebrow: "CHAPTER 02 · THE MECHANIC",
      heading: "TURN GRATITUDE INTO PARTICIPATION.",
      body: "The activation mechanism turned appreciation into social participation. Lay's created custom Heartwork packs and personalized outreach letters. Geek executed the creator-activation layer — reaching influencers, sending customized packs, and coordinating creators as they shared messages of gratitude across their own social channels.",
    },
    {
      blockType: "mediaBlock",
      legacySrc: "/assets/work/lays/heartwork/heartwork-pack-mechanic.jpg",
      alt: "Lay's Heartwork gratitude pack with the personalised campaign letter.",
    },
    {
      blockType: "sectionIntro",
      eyebrow: "CHAPTER 03 · STRATEGIC CONTINUITY",
      heading: "WE DIDN'T START FROM ZERO.",
      body: "Heartwork thanked India's unsung heroes and, crucially for the relationship graph, sent Lay's gratitude packs to fan-club members — including creators acquired through Smile Deke Dekho. This is the campaign that proved the community was an asset you could return to, not a list you rebuild. A list gets used once. A relationship can be activated again.",
    },
    {
      blockType: "sectionIntro",
      eyebrow: "CHAPTER 04 · LOGISTICS & EXECUTION",
      heading: "1,400 PACKS. IN THE MIDDLE OF LOCKDOWN.",
      body: "Executing creator marketing at nationwide scale during partial lockdown was an intense operational exercise. Geek managed the complete execution chain: Database → Outreach → Individual Briefing → Personalised Pack → Custom Letter → Packaging → All-India Courier → Delivery Follow-up → Content → Tracking.",
    },
    {
      blockType: "sectionIntro",
      eyebrow: "CHAPTER 05 · COMMUNITY ASSET",
      heading: "REACTIVATE. DON'T REBUILD.",
      body: "Heartwork demonstrated that creator relationships function as reusable brand assets across campaigns. Returning to an existing community eliminated cold-recruitment friction and proved creator network equity compounds over time. The figures that follow come from Geek's creator-activation report and describe Geek's tracked activation scope — not the total performance of the wider PepsiCo Heartwork campaign.",
    },
    {
      blockType: "metrics",
      heading: "GEEK CREATOR-ACTIVATION SCOPE",
      items: [
        { value: "1,400", label: "Packs / influencers reached", note: "(Geek)" },
        ...
        { value: "4.76M", label: "Tracked reach", note: "(Geek tracked subset)" },
        { value: "3.81M", label: "Engagement", note: "(Geek tracked)" },
      ],
    },
    {
      blockType: "sectionIntro",
      heading: "Historical creator economics (not audited ROI)",
      body: "Geek's report recorded a historical estimated creator-economics comparison: roughly ₹14L spend against roughly ₹158L estimated creator media value, i.e. a stated ~₹1.44Cr value comparison. These are historical, estimated creator-economics figures — not audited ROI, and not a financial return claim.",
    },
    {
      blockType: "sectionIntro",
      heading: "Wider campaign context",
      body: "Independent media reported the broader Heartwork campaign at 1,400+ influencers, 8M+ total organic reach, 4,300+ posts/Stories, ~70,000 conversations and ~50M impressions via leading partner brands. Those wider figures include brand-partner amplification beyond Geek's tracked activation and are kept separate here.",
    },
    {
      blockType: "mediaBlock",
      legacySrc: "/assets/work/lays/heartwork/heartwork-pack-artwork-farmers.jpg",
      alt: "Original Lay's Heartwork influencer pack artwork thanking farmers.",
    },
    {
      blockType: "sectionIntro",
      eyebrow: "CHAPTER 07 · QUALITATIVE IMPACT",
      heading: "THE NUMBER THAT MATTERED WASN'T ONLY REACH.",
      body: "Qualitative feedback confirmed strong community connection. Creators appreciated the gratitude thought and valued brand reposts, while strong participation demand directly drove Phase 2 of the activation.",
    },
    {
      blockType: "sectionIntro",
      eyebrow: "CHAPTER 08 · PRACTITIONER INTELLIGENCE",
      heading: "WHAT SCALE TAUGHT US.",
      body: "Managing 1,400 physical activations under lockdown produced key operational intelligence: corrugated outer packaging protected delivery integrity, lockdown courier friction required active coordination, packaging clarity was essential under COVID restrictions, and creator barter expectations required clear management.",
    },
    {
      blockType: "sectionIntro",
      eyebrow: "CHAPTER 09 · THE LONGER JOURNEY",
      heading: "ONE CAMPAIGN IN A LONGER RELATIONSHIP.",
      body: "Heartwork marks the 'Reactivate' chapter in the Lay's creator progression: Smile Deke Dekho (Acquire) → Heartwork (Reactivate) → MyLaysRelationchip (Scale) → Friends of Lay's (Institutionalise). Influencer Relationship Management was the later productised learning from this compounding history.",
    },
    {
      blockType: "cta",
      heading: "THE COMMUNITY WASN'T DONE GROWING.",
      body: "See how MyLaysRelationchip later activated the accumulated Lay's creator community at database scale.",
      buttonLabel: "See MyLaysRelationchip",
      buttonHref: "/work/mylaysrelationchip",
    },
  ],
  press: [
