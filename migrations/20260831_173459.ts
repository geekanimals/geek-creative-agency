...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_media_rights_status" AS ENUM('geek-owned', 'client-archive', 'licensed', 'press-reference', 'unknown', 'hold');
  ...
  CREATE TABLE "media" (
  	...
  	"caption" varchar,
  	"credit" varchar,
  	"rights_status" "enum_media_rights_status" DEFAULT 'geek-owned' NOT NULL,
